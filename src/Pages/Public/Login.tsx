  ...
  return (
    <div className="relative">
      ...
      <div className="min-h-screen flex items-center justify-center sm:bg-loginImage md:bg-none animate-changeOpacity">
        <div className="max-w-screen-2xl max-h-screen sm:p-5 md:p-0 sm:w-full sm:ml-10 sm:mr-10 xl:w-128 xl:h-128 rounded-lg sm:bg-offwhite md:bg-white shadow-lg">
